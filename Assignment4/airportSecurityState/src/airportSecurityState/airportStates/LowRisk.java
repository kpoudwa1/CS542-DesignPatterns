...
/**
 * A class representing the LowRisk condition of the Airport.
...
public class LowRisk implements AirportStateI
{
	...
	/*Constant string representing the operations to be performed
	 in LowRisk condition*/
	private static final String OPERATION_ID = "1 3 5 7 9";
	
	/**
	 * Creates a LowRisk instance initialized with the reference
	 *  to the Airport instance
	 * @param airport The reference for the
	 *  Airport instance
	 */
	public LowRisk(Airport airport)
	{
		MyLogger.writeMessage("LowRisk()", DebugLevel.CONSTRUCTOR);
