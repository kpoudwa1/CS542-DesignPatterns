...
/**
 * A class representing the HighRisk condition of the Airport.
...
public class HighRisk implements AirportStateI
{
	...
	/*Constant string representing the operations to be performed
	 in HighRisk condition*/
	private static final String OPERATION_ID = "2 4 6 8 10";
	
	/**
	 * Creates a HighRisk instance initialized with the reference
	 *  to the Airport instance
	 * @param airport The reference for the
	 *  Airport instance
	 */
	public HighRisk(Airport airport)
	{
		MyLogger.writeMessage("HighRisk()", DebugLevel.CONSTRUCTOR);
